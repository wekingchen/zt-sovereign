...
- v0.4.1 首次启动默认生成随机一次性 admin 密码，而不是使用上游默认 `admin/password`。
...
- Controller 跟踪最新 ZeroTier 正式版本候选，但只通过自动 PR 提议；必须经过 Controller API、ztncui CRUD、重启持久化和 Upgrade Test 后人工合并。
